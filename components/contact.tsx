...
export default function Contact() {
    return (
        ...
        {/* GLOW */}
        <div className="absolute top-[-150px] left-[-100px] w-100 h-100 bg-green-400/10 blur-3xl rounded-full" />

        <div className="absolute bottom-[-150px] right-[-100px] w-100 h-100 bg-blue-500/10 blur-3xl rounded-full" />
