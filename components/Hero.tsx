    ...
    <section className="relative overflow-hidden pb-24 pt-36 md:pb-36 md:pt-52">
      ...
      <div className="relative mx-auto max-w-6xl px-5 md:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <motion.span
            {...fadeUp(0)}
            className="inline-flex items-center gap-2 rounded-full border border-ocean-600/30 dark:border-white/10 bg-white dark:bg-white/5 shadow-sm dark:shadow-none px-4 py-1.5 text-sm font-medium dark:text-ocean-200 text-foreground"
          >
